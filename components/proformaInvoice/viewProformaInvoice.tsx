...
import AddInvoicePopup from "./addProformaInvoice";
import { fetchProformaInvoiceById } from "@/lib/actions/proforma_invoice";
...
const ViewProformaInvoice = ({ id }: { id: number }) => {
                ...
                >
                    <DialogHeader className="no-print p-6 pb-2">
                        <div className="flex items-center justify-start gap-2">
                            ...
                            <AddProformaInvoice mode="update" id={id} />
                            <AddProformaInvoice mode="renew" id={id} />
                        </div>
                        <DialogDescription>
                        ...
                        <div className="flex-1 border border-primary bg-[url('/light-logo-25.png')] bg-size-[200px_200px] bg-no-repeat bg-center">
                            ...
                            <header className="grid grid-cols-[20%_60%_20%] my-2 print:no-break">
                                ...
                                <div className="mt-2 flex flex-col items-center text-center">
                                    ...
                                    <h1 className="text-3xl mt-2 font-semibold">Pro Forma Invoice</h1>
                                </div>
